...
const BUILD_COMMANDS = [
  { args: ["--filter", "@galyarder-design/contracts", "build"] },
  { args: ["--filter", "@galyarder-design/registry-protocol", "build"] },
  { args: ["--filter", "@galyarder-design/sidecar-proto", "build"] },
  { args: ["--filter", "@galyarder-design/sidecar", "build"] },
  { args: ["--filter", "@galyarder-design/platform", "build"] },
  { args: ["--filter", "@galyarder-design/agui-adapter", "build"] },
  { args: ["--filter", "@galyarder-design/plugin-runtime", "build"] },
  { args: ["--filter", "@galyarder-design/daemon", "build"] },
  { args: ["--filter", "@galyarder-design/web", "build"], env: ["GD_WEB_OUTPUT_MODE"] },
  { args: ["--filter", "@galyarder-design/web", "build:sidecar"] },
  { args: ["--filter", "@galyarder-design/desktop", "build"] },
  { args: ["--filter", "@galyarder-design/packaged", "build"] },
] as const;
