...
- **Why it matters:** It names the core loop GD needs for design work: solve once, verify, save the execution path, and recall it with less context next time.
- **What we borrow:**
...
- **What we don't:**
  - Broad uncontrolled desktop authority. GD keeps daemon, connector, filesystem, and review gates explicit.
...
- **What we borrow:**
  ...
  - Ecosystem compatibility: any of their 68 DESIGN.md files works as an GD active design system out of the box.
- **What we don't:**
...
The two empty-column crossings where GD lights up and others don't: **Vercel-deployable + design-system authoring**, and **uses existing code agent + first-class DESIGN.md**. That's the niche.
