...
import { wellKnownUserToolchainBins } from '@galyarder-design/platform';
...
function userToolchainDirs() {
  const homeOverride = process.env.GD_AGENT_HOME;
  ...
  // When GD_AGENT_HOME is set, scope the search strictly to the override
