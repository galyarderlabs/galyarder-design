...
mac_dmg="galyarder-design-$RELEASE_VERSION$asset_version_suffix-mac-arm64.dmg"
mac_zip="galyarder-design-$RELEASE_VERSION$asset_version_suffix-mac-arm64.zip"
mac_intel_dmg="galyarder-design-$RELEASE_VERSION$mac_intel_asset_suffix-mac-x64.dmg"
mac_intel_zip="galyarder-design-$RELEASE_VERSION$mac_intel_asset_suffix-mac-x64.zip"
win_installer="galyarder-design-$RELEASE_VERSION$win_asset_suffix-win-x64-setup.exe"
linux_appimage="galyarder-design-$RELEASE_VERSION$linux_asset_suffix-linux-x64.AppImage"
