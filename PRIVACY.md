...
This page describes what data the Galyarder Design desktop and web app collects,
...
Galyarder Design is **local-first**. Your projects, generated files, and BYOK API
...
When telemetry is enabled, the app may send the following to the Galyarder Design
...
the Galyarder Design team, which forwards them to [Langfuse](https://langfuse.com)
...
Galyarder Design is BYOK at every layer. The API keys you configure for coding
agents and model providers are stored locally and used only to talk to those
providers directly. They are never sent to the Galyarder Design team.
...
[GitHub Discussion](https://github.com/galyarderlabs/galyarder-design/discussions).
