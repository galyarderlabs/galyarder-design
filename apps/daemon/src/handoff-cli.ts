// `gd project handoff` — the CLI surface for the resume-conversation
...
// the `gd` CLI as well as the web UI; both drive the same
...
import type { HandoffRequest, HandoffResponse } from '@galyarder-design/contracts/api/handoff';
...
const USAGE = `Usage:
  gd project handoff <projectId> --conversation <id> --api-key <key> --model <model>
