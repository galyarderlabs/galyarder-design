...
**Mobile app embedded:** Founder YouHei (`FZ YouHei`) ships in the iOS / Android app; users can fall back to system PingFang SC / Noto Sans CJK SC.
...
|---|---|---|---|---|
| Not following | `#FF2442` | `+ Follow` (Follow) | white | pill |
| Following | `rgba(48,48,52,0.10)` | `Following` (Following) | `rgba(0,0,0,0.45)` | pill |
| Mutual | `rgba(48,48,52,0.10)` | `Mutual` (Mutual) | `rgba(0,0,0,0.62)` | pill |
...
- Tab strip below: Notes / Saved / Liked (Notes / Saved / Liked)
...
- Follow button (idle): same as primary CTA, label `+ Follow` (Follow)
- Follow button (following): `background: rgba(48,48,52,0.10); color: rgba(0,0,0,0.45); border-radius: 9999px;` label `Following` (Following)
