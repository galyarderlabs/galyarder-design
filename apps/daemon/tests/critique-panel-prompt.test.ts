...
import { defaultCritiqueConfig, CRITIQUE_PROTOCOL_VERSION } from '@galyarder-design/contracts/critique';
...
describe('renderPanelPrompt', () => {
  ...
  it('multibyte brand DESIGN.md (CJK) is preserved verbatim', () => {
    // UTF-8 / CJK fixture; verifies code preserves non-ASCII bytes through prompt rendering.
    const cjkMd = '## 品牌\n颜色: oklch(60% 0.18 45)\n字体: Noto Serif CJK。';
