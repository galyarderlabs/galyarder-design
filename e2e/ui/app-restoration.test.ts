...
<html>
  ...
  <body>
    <main>
      <section data-gd-id="hero" data-gd-label="Hero section">
...
async function runCommentAttachmentFlow(
  ...
  await frame.locator('[data-gd-id="hero-title"]').click();
  ...
  await frame.locator('[data-gd-id="hero-copy"]').hover();
...
async function runDeckPaginationNextPrevCorrectnessFlow(page: Page) {
  ...
  await page.reload();
  await galyarderDesignFile(page, 'pagination.html');
...
async function runDeckPaginationPerFileIsolatedFlow(page: Page) {
  ...
  await galyarderDesignFile(page, 'deck-alpha.html');
  const frame = page.frameLocator('[data-testid="artifact-preview-frame"]');
  ...
  await page.getByTestId('design-files-tab').click();
  await galyarderDesignFile(page, 'deck-beta.html');
...
async function runUploadedImageRendersInPreviewFlow(page: Page) {
  ...
  await page.reload();
  await galyarderDesignFile(page, 'image-preview.html');
...
async function runPythonSourcePreviewFlow(page: Page) {
  ...
  await page.reload();
  await galyarderDesignFile(page, 'app.py');
