...
const TOGGLE_EVENT = 'galyarder-design:critique-theater-toggle';
 ...
 *
 * Source of truth is the existing `galyarder-design:config` localStorage
 ...
 *   2. A same-tab `galyarder-design:critique-theater-toggle` CustomEvent so
