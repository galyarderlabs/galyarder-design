...
//     to `restricted` until an explicit `gd plugin trust <id>` flips it. Phase
...
import type { InstalledPluginRecord, PluginManifest, TrustTier } from '@galyarder-design/contracts';
...
// plugin can be promoted to via `gd plugin trust`. Anything outside this
