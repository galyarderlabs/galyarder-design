...
// minimum surface GD currently needs:
//
...
//
// Spec §10.3.5 / Phase 4 — GD's native PersistedAgentEvent / GenUIEvent
...
export interface AGUIEventBase {
  ...
  kind: AGUIEventKind;
  // The GD run id this event belongs to.
  runId: string;
...
export interface AGUISurfaceRequestedEvent extends AGUIEventBase {
  ...
  surfaceId: string;
  // GD's surface kinds map directly onto AG-UI's three tiers
