...
import { atomicCopyFile, isProcessAlive, pathContains, removePathBestEffort } from "@galyarder-design/platform";

const STORE_SENTINEL = ".galyarder-design-download-root.json";
const STATE_DIR = ".state";
const PARTIAL_DIR = ".partial";
const LOCK_DIR = ".locks";
const STORE_SCHEMA_VERSION = 1;
const MANIFEST_SCHEMA_VERSION = 1;
const STORE_KIND = "galyarder-design-managed-download-root";
const MANIFEST_KIND = "galyarder-design-managed-download";
