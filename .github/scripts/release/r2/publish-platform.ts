...
if (platform === "mac") {
  ...
  const dmg = `galyarder-design-${releaseVersion}${suffix}-mac-arm64.dmg`;
  const zip = `galyarder-design-${releaseVersion}${suffix}-mac-arm64.zip`;
  ...
  const installer = `galyarder-design-${releaseVersion}${suffix}-win-x64-setup.exe`;
  config = {
    arch: "x64",
  ...
  const appImage = `galyarder-design-${releaseVersion}${suffix}-linux-x64.AppImage`;
  config = {
    arch: "x64",
  ...
  const dmg = `galyarder-design-${releaseVersion}${suffix}-mac-x64.dmg`;
  const zip = `galyarder-design-${releaseVersion}${suffix}-mac-x64.zip`;
  config = {
    arch: "x64",
    artifacts: {
