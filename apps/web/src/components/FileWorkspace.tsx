...
import type { TrackingProjectKind } from '@galyarder-design/contracts/analytics';
        ...
        {fontFiles.length === 0 ? (
          <div className="ds-project-warning-card">
            ...
            <span>
              ...
              <small>Galyarder Design is rendering typography with substitute web fonts.</small>
            </span>
...
function designSystemSectionRunningNotice(
  ...
  if (activity.phase === 'reading') {
    return `Galyarder Design is reading ${section.title} context for this section.`;
  }
