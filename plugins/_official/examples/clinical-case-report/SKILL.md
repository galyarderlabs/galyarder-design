...
- Tag every major section with `data-gd-id` for comment-mode targeting:

```html
<section data-gd-id="hpi">...</section>
<section data-gd-id="vitals">...</section>
<section data-gd-id="pmh">...</section>
<section data-gd-id="examination">...</section>
<section data-gd-id="investigations">...</section>
<section data-gd-id="assessment">...</section>
<section data-gd-id="plan">...</section>
```
