...
const DISCORD_INVITE_URL = "https://github.com/galyarderlabs/galyarder-design/discussions";
      ...
      <div className="plugin-action-panel__head">
        ...
        <div>
          ...
          <div className="plugin-action-panel__subtitle">
            Send the next step to the agent so it can run the gd CLI.
          </div>
        </div>
      </div>
...
function hasPluginFinalActionHint(content: string): boolean {
  return /\b(Add to My plugins|Galyarder Design PR|Publish repo|plugin publish|ready to publish|ready to add)\b/i.test(
    content,
  );
}
