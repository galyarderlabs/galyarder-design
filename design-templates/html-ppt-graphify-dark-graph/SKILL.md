...
description: Dark-themed knowledge graph deck — featuring a midnight gradient background (#06060c to #0e1020) + floating blur orbs, an interactive SVG force-directed cover graph, rainbow gradient headers, JetBrains Monospace command-line code blocks, and premium glassmorphic cards. Tailored for developer tools, CLI utilities, knowledge graphs, or data visualization keynotes seeking a science-fiction, AI-native vibe.
triggers:
  - "Knowledge graph"
  - "graph deck"
  - "dark graph"
...
od:
  ...
  animations: true
  example_prompt: >-
    Create a developer tool launch presentation using the html-ppt-graphify-dark-graph template. Setup a midnight gradient background, force-directed graph cover, rainbow header, and JetBrains Monospace CLI command-line boxes. First confirm: tool name, key capabilities, demo sequence, and whether to include a live-CLI terminal slide.
---
# HTML PPT · Dark Knowledge Graph
