// Plan §3.K3 / spec §10.3.5 — gd.genui.surfaces[].component manifest field.
//
// Two contracts:
//   1. The Zod schema in @galyarder-design/contracts accepts the new
...
import { GenUISurfaceSpecSchema } from '@galyarder-design/contracts';
import { validateSafe } from '@galyarder-design/plugin-runtime';
...
describe('doctorPlugin — component capability gate', () => {
  ...
  it('passes when the matching capability is declared', () => {
    const m: PluginManifest = {
      ...baseManifest,
      gd: { ...baseManifest.gd, capabilities: ['prompt:inject', 'genui:custom-component'] },
    };
