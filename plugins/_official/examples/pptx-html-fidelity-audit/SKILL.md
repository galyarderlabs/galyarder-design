...
| 5 checklist | row B step description bottom at 7.2" cut off by footer | 🔴 |
| 8 3E | closing paragraph sits directly on the footer's top edge | 🔴 |
| 9 on-day | step description bottom just touches the footer with no safety margin | 🟠 |
