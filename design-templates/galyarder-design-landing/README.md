...
- **Path:** `skills/editorial-collage/` → `skills/galyarder-design-landing/`.
- **Shared assets:** downstream paths such as `../editorial-collage/assets/`
  (for example from the slide-deck skill) should use
  [`../galyarder-design-landing/assets/`](./assets/) — see
  [`galyarder-design-landing-deck`](../galyarder-design-landing-deck/README.md).
...
- [`skills/galyarder-design-landing-deck/`](../galyarder-design-landing-deck/) — sibling skill that produces a slide deck in the same visual language.
