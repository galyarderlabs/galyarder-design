...
description: >
  ...
  collage) — the same aesthetic Galyarder Design uses for its own marketing
...
sibling [`galyarder-design-landing-deck`](../galyarder-design-landing-deck/) skill)
...
This is the canonical Galyarder Design marketing-page recipe — the example
output is the very page you see at [galyarder-design](https://github.com/galyarderlabs/galyarder-design).
...
worked example (Galyarder Design itself).
...
`pnpm --filter @galyarder-design/landing-page build` for a static `out/`
...
└── assets/
    ├── *.png                # 16 collage plates (Galyarder Design instance)
...
- [`skills/galyarder-design-landing-deck/`](../galyarder-design-landing-deck/) — sibling slides skill that reuses this design system.
