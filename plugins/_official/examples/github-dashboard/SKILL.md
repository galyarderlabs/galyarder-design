...
od:
  ...
  capabilities_required:
    - shell
    - file_write
  example_prompt: "Build a GitHub dashboard for galyarderlabs/galyarder-design — stars, forks, contributors, issues, PRs, recent activity, and top contributors."
---
...
6. **Write the artifact**
   ...
   - Tag major regions with stable `data-gd-id` values: `sidebar`, `topbar`, `repo-header`, `kpi-strip`, `growth-chart`, `contributors`, `activity`, `provenance`.
