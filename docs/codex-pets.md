...
Galyarder Design discovers them, and what to do if you do not have Codex
installed.
...
You do not need Codex to use Galyarder Design. The pet companion ships with
...
the daemon never writes outside `GD_DATA_DIR` / project-owned paths
