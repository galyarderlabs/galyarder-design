...
// `gd` CLI distribution path serves `apps/web/out/_next/static/chunks/`
...
import { createPackageManagerInvocation } from "@galyarder-design/platform";

import type { ToolPackConfig } from "./config.js";
import { execFileAsync } from "./mac/commands.js";

const POSTHOG_CLI_VERSION = "0.7.11";
const RELEASE_NAME = "galyarder-design-web";
...
async function runPnpm(
  ...
  // (which sets `GD_TOOLS_PACK_PNPM_BIN` to the standalone pnpm binary it
