...
// talk to the GD UI directly. Polling /api/xai/auth/status is the only
    ...
    <div className={`mcp-oauth-control${connected ? ' connected' : ''}`}>
        ...
        {connected ? (
          ...
          <>
            ...
            <span>
              ...
              <span className="hint">
                Galyarder Design is listening for the callback in the background.
          ...
          <>
            ...
            <span>
              ...
              <span className="hint">
                ...
                Grok image, video, and TTS in Galyarder Design — no API key
                needed.
              </span>
            </span>
          </>
      ...
      {isAwaiting ? (
        <div className="xai-oauth-warning" role="status">
          ...
          <em>"Cannot connect to your application"</em> (or the equivalent
          in your local language). <strong>That is a UX bug on xAI's side</strong> — the
          authorization is still being delivered to Galyarder Design in the
