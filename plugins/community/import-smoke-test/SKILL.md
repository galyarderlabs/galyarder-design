...
description: A portable community plugin for validating Galyarder Design plugin import flows.
---

# Community Import Smoke Test

Use this plugin when validating that Galyarder Design can import community plugins
