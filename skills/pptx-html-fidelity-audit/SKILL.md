...
|---|---|---|
| 1 cover | bottom of meta-row at 6.95" overlapping the footer (6.7") | 🔴 |
| 5 checklist | row B step description bottom cut off by footer at 7.2" | 🔴 |
| 8 3E | concluding paragraph positioned directly at the start of footer | 🔴 |
| 9 on-day | bottom of step description barely touching the footer, no safety margin | 🟠 |
| Multiple Locations | em (Playfair italic) not preserved | 🟡 |
```
