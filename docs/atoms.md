...
> The atomic capabilities Galyarder Design exposes to plugins.
...
The Galyarder Design daemon is responsible for resolving each atom into a system-prompt
