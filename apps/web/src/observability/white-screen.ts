...
//
//   1. The App component has set `data-gd-app-mounted="1"` on
...
//      `<div class="gd-loading-shell">Loading Galyarder Design…</div>`
...
// whether the app rendered something meaningful. `gd-loading-shell` is
// the dynamic-import fallback rendered by `client-app.tsx`.
const LOADING_SHELL_CLASSES = new Set(['gd-loading-shell']);
const APP_MOUNTED_ATTR = 'data-gd-app-mounted';
