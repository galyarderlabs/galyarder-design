...
export const ptBR: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do Galyarder Design (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao Galyarder Design.',
  ...
  'settings.mcpServerHint': 'Exponha o Galyarder Design como servidor MCP para o seu agente de código.',
  ...
  'entry.githubStarAria': 'Dar uma estrela ao Galyarder Design no GitHub',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o Galyarder Design está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no Galyarder Design — escolha um e adote.',
  ...
  'pet.slashSearch': 'Pesquise na web pelo comando GD research.',
  ...
  'pet.codexBundledTitle': 'Já vem com o Galyarder Design — sem download.',
  ...
  'updater.availableBody': 'Galyarder Design {version} está disponível. Ela será baixada antes que o instalador possa abrir.',
  ...
  'updater.installerOpenBody': 'O instalador está aberto. O Galyarder Design está saindo para que você conclua a atualização.',
  ...
  'updater.quitButton': 'Sair do Galyarder Design',
  'updater.quitFailedBody': 'O instalador está aberto, mas não foi possível sair do Galyarder Design. Saia do Galyarder Design antes de substituir o app.',
  'updater.quitFailedTitle': 'Não foi possível sair',
  'updater.quitting': 'Saindo...',
  'updater.ready': 'Atualização pronta',
  'updater.readyGeneric': 'Uma nova versão está pronta. O Galyarder Design será fechado e abrirá o instalador.',
  'updater.readyVersion': 'Galyarder Design {version} está pronto. O Galyarder Design será fechado e abrirá o instalador.',
