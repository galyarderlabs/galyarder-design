...
description: GitHub-inspired dark gradient deck — leveraging a GitHub-dark (#0d1117) background + radial purple-blue ambient glows, 60px grid mask overlays, centered content flow, purple pill badges, tri-color gradient headers (#a855f7 to #60a5fa to #34d399), GitHub-style code block colors, and purple left-border accents. Ideal for developer workflows, MCP servers, AI agents, or dev tool tutorials, matching the aesthetic of GitHub's blog or the Linear changelog.
triggers:
  - "github dark"
  - "developer tutorial"
  - "mcp tutorial"
...
od:
  ...
  animations: true
  example_prompt: >-
    Create a developer tutorial presentation using the html-ppt-obsidian-claude-gradient template. Set up the GitHub dark gradient look with purple accent pills, gradient display titles, and code snippets. First confirm: tutorial topic, target audience, and whether you need MCP or Agent configuration snippets.
---
