...
export const fa: Dict = {
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به Galyarder Design، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'Galyarder Design را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'entry.githubStarAria': 'به Galyarder Design در GitHub ستاره بدهید',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Galyarder Design در حال اجراست و دوباره تلاش کنید.',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Galyarder Design — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.slashSearch': 'وب را با فرمان GD research جستجو کنید.',
  ...
  'pet.codexBundledTitle': 'همراه Galyarder Design ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'updater.availableBody': 'Galyarder Design {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. Galyarder Design در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن Galyarder Design',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما Galyarder Design بسته نشد. پیش از جایگزینی برنامه، Galyarder Design را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. Galyarder Design بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'Galyarder Design {version} آماده است. Galyarder Design بسته می‌شود و نصب‌کننده را باز می‌کند.',
