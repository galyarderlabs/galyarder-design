...
import type { ProjectKind, ProjectMetadata } from '@galyarder-design/contracts';
import type { DefaultScenarioPluginId } from '@galyarder-design/contracts';
...
export const HOME_HERO_CHIPS: ReadonlyArray<HomeHeroChip> = [
  {
    ...
    // gd-new-generation router left the agent to invent every section's
  ...
  },
  {
    ...
    // previous routing to gd-new-generation gave the agent only the
  ...
  },
  {
    ...
    icon: 'edit',
    group: 'migrate',
    hint: 'Author a reusable Galyarder Design plugin and add it to My plugins.',
