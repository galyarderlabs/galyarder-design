// Contract test for the `gd project handoff` CLI surface. Keeps the
...
describe('gd project handoff CLI', () => {
  let stdout: string[];
  let stderr: string[];
  ...
  // Malformed flags must reach this structured fail() path. `gd project
