...
function reportFilesFor(key) {
  if (key === "mac") {
    return [
      "manifest.json",
      "screenshots/galyarder-design-mac-smoke.png",
      "suite-result.json",
      "tools-pack.json",
      "tools-pack.log",
      "vitest.log",
  ...
  if (key === "win") {
    return [
      "manifest.json",
      "screenshots/galyarder-design-win-smoke.png",
      "suite-result.json",
      "tools-pack.json",
      "vitest.log",
    ];
  ...
  if (key === "linux") {
    return ["manifest.json", "screenshots/galyarder-design-linux-smoke.png", "vitest.log"];
  }
  return [];
}
