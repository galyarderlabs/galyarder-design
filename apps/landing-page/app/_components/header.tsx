...
export interface HeaderProps {
   ...
   * the Japanese label (`日本語`, kept here as a CJK example for the
   * docstring) from `/zh-CN/blog/` goes straight to `/ja/blog/`, not
   * `/ja/`.
   */
  pathname?: string;
}
...
export function Header({
  ...
  return (
    <header className='nav' data-gd-id='nav' data-nav-headroom>
      <div className='container nav-inner'>
        ...
        */}
        ...
        <nav id='primary-nav' data-nav-primary>
          <ul className='nav-links'>
            <li className='has-dropdown'>
              {/*
                Product menu — top-level group exposing the Galyarder Design family.
        ...
        <div className='nav-side'>
           ...
           */}
          <details className='nav-locale' data-gd-id='nav-locale'>
            <summary
