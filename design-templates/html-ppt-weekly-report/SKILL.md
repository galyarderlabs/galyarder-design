...
description: Team weekly / status-update deck — corporate clarity, 8-cell KPI grid, shipped list, 8-week bar chart, next-week table. Use for weekly status, business reviews, team status updates, and exec dashboards.
triggers:
  - "weekly report"
  - "Weekly report"
  - "status update"
...
od:
  ...
  animations: true
  example_prompt: >-
    Create a 7-slide weekly status deck using the html-ppt-weekly-report template. First prompt me for four things: this week's date range, 3-5 core KPI numbers, completed highlights, and upcoming plans/risks. Then fill out the 8-week progress bar chart and next week's agenda table.
---
