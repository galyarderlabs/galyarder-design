...
description: GitHub dark-purple gradient deck — GitHub dark #0d1117 + a purple-blue radial ambient light + 60px grid mask, centered layout, purple pill tags, three-color gradient headline (#a855f7→#60a5fa→#34d399), GitHub-style code palette, and purple left-border highlight blocks. Built for developer-workflow / MCP / agent / dev-tool tutorials, in the spirit of GitHub Blog or Linear Changelog.
triggers:
  - "github dark"
  - "developer tutorial"
  - "mcp tutorial"
...
od:
  ...
  speaker_notes: true
  animations: true
  example_prompt: "Use the html-ppt-obsidian-claude-gradient template to create a developer tutorial deck. GitHub dark-purple gradient + centered layout + purple pill tags + tri-color gradient headline + config/step code blocks. First confirm: what you're teaching, the target audience, and whether to include MCP/agent config examples."
---
