...
describe('buildOrbitSystemPrompt', () => {
  it('embeds selected Orbit template instructions and staged side-file guidance', () => {
    ...
    expect(prompt).toContain('Staged root: .gd-skills/orbit-general/');
    expect(prompt).toContain('read ".gd-skills/orbit-general/SKILL.md"');
    expect(prompt).toContain('".gd-skills/orbit-general/example.html"');
