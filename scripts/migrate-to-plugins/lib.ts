...
export const PLUGIN_SCHEMA = 'https://galyarder-design.ai/schemas/plugin.v1.json';
...
// identity → metadata → compat → gd → end. Inside `gd`, we keep the
