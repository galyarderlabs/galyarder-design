...
describe('@galyarder-design/contracts package runtime shape', () => {
  ...
  it('makes runtime exports importable through package exports', async () => {
    const contracts = await import('@galyarder-design/contracts');
    const connectionTest = await import('@galyarder-design/contracts/api/connectionTest');
    const research = await import('@galyarder-design/contracts/api/research');
    const handoff = await import('@galyarder-design/contracts/api/handoff');
    const critique = await import('@galyarder-design/contracts/critique');
