...
source_dmg="$RUNNER_TEMP/tools-pack/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/dmg/Galyarder Design-$TOOLS_PACK_NAMESPACE.dmg"
source_zip="$RUNNER_TEMP/tools-pack/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/zip/Galyarder Design-$TOOLS_PACK_NAMESPACE.zip"
...
versioned_dmg="galyarder-design-${RELEASE_VERSION}${asset_suffix}-mac-arm64.dmg"
versioned_zip="galyarder-design-${RELEASE_VERSION}${asset_suffix}-mac-arm64.zip"
...
release_notes="${RELEASE_NOTES:-Galyarder Design $RELEASE_VERSION$asset_suffix}"
