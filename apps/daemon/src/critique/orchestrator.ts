...
import type { CritiqueConfig, PanelEvent } from '@galyarder-design/contracts/critique';
import { panelEventToSse } from '@galyarder-design/contracts/critique';
...
const tracer = trace.getTracer('@galyarder-design/daemon/critique');
