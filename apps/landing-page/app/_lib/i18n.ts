/*
 * Locale dictionary for the landing-page chrome (nav, footer, blog
 * labels). Functions identically to dictionary content under
 * `apps/web/src/i18n/locales/`. Non-English literals below are the
 * canonical translated copy for each supported locale; treat as locale
 * data for the purposes of the repo's "100% English" policy.
 */
