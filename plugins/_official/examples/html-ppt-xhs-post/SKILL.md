...
description: RedNote (xiaohongshu) / Instagram-style 9-card 3:4 portrait photo set (810×1080) — warm pastels, dashed sticker cards, dotted page indicator at the bottom. Built for RedNote photo posts, Instagram carousels, and brand-seeding content.
triggers:
  - "rednote"
  - "xhs"
  - "xhs post"
...
od:
  ...
  speaker_notes: true
  animations: true
  example_prompt: "Use the html-ppt-xhs-post template to build a 9-card RedNote (xiaohongshu) photo set (3:4 portrait, 810×1080). First share the topic, then assemble the cover + 7 content cards + closing CTA, with one headline + one paragraph + a keyword sticker per card."
---
# HTML PPT · RedNote (xiaohongshu) photo set
