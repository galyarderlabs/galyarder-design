...
- **`default/`** — Neutral Modern. Hand-authored starter for the GD spec.
...
- **`atelier-zero/`** — Atelier Zero. Hand-authored magazine-grade
  ...
  coral accent. Pairs with [`skills/galyarder-design-landing/`](../skills/galyarder-design-landing/)
  and [`skills/galyarder-design-landing-deck/`](../skills/galyarder-design-landing-deck/)
  for the canonical landing-page and slide-deck renderings.
- **`kami/`** — Kami (paper). Editorial paper system distilled from
