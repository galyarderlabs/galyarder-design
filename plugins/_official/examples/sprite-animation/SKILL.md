...
description: |
  ...
  "Nintendo-style", "vintage animation", or "retro pixel art".
triggers:
  - "sprite animation"
  - "pixel art animation"
  - "8-bit explainer"
...
4. **Top bar** — small mono row:
   - Left: title slug ("Showtimes" or "EP. 01 / NINTENDO")
...
5. **Subject animations** — at least three independent looping animations
   ...
   - **Kinetic kana**: 1–2 Japanese / kanji characters that fade-and-slide
     in sync with the bob (e.g. "Hana" — flower).
...
7. **Write** a single HTML document:
   ...
   - `data-gd-id` on stage, year, sprite, caption, and tick ribbon.
8. **Self-check**:
