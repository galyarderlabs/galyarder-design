...
Spec §11.5.1 / §21.5: an GD run isn't done when the artifact
...
| `desktop` | open the project in the GD desktop app |
...
| `github` | open a PR via `gd plugin publish --to <catalog>` |
