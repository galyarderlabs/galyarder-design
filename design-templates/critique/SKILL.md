...
description: |
  ...
  review", "design critique", "5-Dimension Audit", "design audit", or "what's
...
od:
  ...
  design_system:
    requires: false
  example_prompt: >-
    Run a 5-dimension critique on the magazine-web-ppt deck I just generated — score philosophy / hierarchy / detail / function / innovation, give me Keep / Fix / Quick-wins.
---

# Critique Skill · 5-Dimensional Expert Review
...
1. **Header** — what artifact was reviewed, date, reviewer ("GD ·
...
### 1. Philosophy consistency · Philosophy Consistency
...
### 3. Detail execution · Meticulous Execution
