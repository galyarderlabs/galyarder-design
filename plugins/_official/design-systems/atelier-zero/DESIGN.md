...
galyarder-design-landing skill. Several common image-model defaults will
...
See `skills/galyarder-design-landing/assets/imagegen-prompts.md` for the
...
- Always include the metadata strip, the side rails, the Roman
  section rules, and a footer with a giant `Galyarder Design.` (or brand)
