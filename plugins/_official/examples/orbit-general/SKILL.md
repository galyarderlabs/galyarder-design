...
1. **Hero** — single row, ~80px tall.
   ...
   Right of name: `· Wed · May 6, 2026` (muted, 18px).
...
2. **KPI strip** — single row, ~120px tall, 5 columns equal width.
   ...
   Suggested labels: `TO DO / TO REVIEW / MEETINGS / @ MENTIONS / AGENT RUNS`.
...
| Knowledge     | Notion, Confluence, Lark Doc          | Doc title + 2-line excerpt block; comment quote in italic serif |
