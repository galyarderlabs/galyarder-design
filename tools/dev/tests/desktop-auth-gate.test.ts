 ...
 * was leaving the daemon ungated because `GD_REQUIRE_DESKTOP_AUTH=1`
 ...
 * @see https://github.com/galyarderlabs/galyarder-design/pull/974
 */
import assert from "node:assert/strict";
import { describe, it } from "node:test";

import { APP_KEYS, type DaemonStatusSnapshot, type WebStatusSnapshot } from "@galyarder-design/sidecar-proto";
