...
// loopback-redirect shape Galyarder Design's xAI Settings panel uses), so it's
// already authenticated by the time GD detects the binary; GD does not
...
// least chat with grok inside GD, this defaults to `plain` streamFormat
