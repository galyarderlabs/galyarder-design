...
import type { GalyarderDesignHostProjectImportSuccess } from '@galyarder-design/host';
...
import { agentIdToTracking } from '@galyarder-design/contracts/analytics';
...
// lives in `@galyarder-design/contracts` so the daemon's `/api/projects`
...
function defaultPluginInputsForCreate(
  ...
  if (pluginId !== 'gd-media-generation') return null;
...
interface Props {
  ...
  onImportFolderResponse?: (response: GalyarderDesignHostProjectImportSuccess) => Promise<void> | void;
  ...
  onGalyarderDesignSystem?: (id: string) => void;
...
export function EntryShell({
  ...
  // submits now arrive with the hidden gd-default router plugin and
              ...
              designSystemsLoading ? (
                ...
                <div className="entry-section">
                  ...
                  <DesignSystemsTab
                    ...
                    onOpenSystem={onGalyarderDesignSystem}
...
function OnboardingView({
  ...
  function deriveOnboardingSourceType(
    snapshot: DesignSystemGenerateSnapshot,
  ): import('@galyarder-design/contracts/analytics').TrackingOnboardingSourceType {
