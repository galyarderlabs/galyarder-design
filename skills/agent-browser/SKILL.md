...
description: |
  ...
  apps, dogfooding Galyarder Design previews, QA, bug hunts, or reviewing app
  quality. Prefer local Galyarder Design preview URLs unless the user explicitly
...
Use `agent-browser` for local Galyarder Design preview validation: inspect rendered
...
With the Galyarder Design preview at `http://127.0.0.1:17573/`, run:
...
Expected success: title `Galyarder Design`, current URL under `127.0.0.1:17573`,
visible Galyarder Design UI text in the snapshot, and a screenshot at
