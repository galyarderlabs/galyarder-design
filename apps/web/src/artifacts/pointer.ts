...
// Matches "see <file>.html" or its Chinese equivalent "见 <file>.html"
// at the start of a chat reply. CJK '见' (Chinese for "see") and the
// fullwidth colon `：` and stop `。` are kept verbatim as functional
// detection patterns matching agent output in either language.
