...
export function registerProjectRoutes(app: Express, ctx: RegisterProjectRoutesDeps) {
  ...
  function collectBundledScenarios() {
    type ScenarioEntry = {
      ...
      pipeline: NonNullable<NonNullable<PluginManifest['gd']>['pipeline']>;
    };
  ...
  app.get('/api/projects', (_req, res) => {
    try {
      ...
      /** @type {import('@galyarder-design/contracts').ProjectsResponse} */
      const body = {
  ...
  app.post('/api/projects', async (req, res) => {
    try {
      ...
      /** @type {import('@galyarder-design/contracts').CreateProjectResponse} */
      const body = {
  ...
  app.get('/api/projects/:id', (req, res) => {
    ...
    /** @type {import('@galyarder-design/contracts').ProjectResponse} */
  ...
  app.patch('/api/projects/:id', async (req, res) => {
    try {
      ...
      //      silently fall back to .gd/projects/<id>.
...
export function registerProjectFileRoutes(app: Express, ctx: RegisterProjectFileRoutesDeps) {
  ...
  app.post('/api/projects/:id/files/rename', async (req, res) => {
    try {
      ...
      /** @type {import('@galyarder-design/contracts').RenameProjectFileResponse} */
      const body = result;
      res.json(body);
    } catch (err: any) {
      if (err?.code === 'EEXIST') {
