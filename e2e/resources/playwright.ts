...
export const playwrightUiScenarios: UiScenario[] = [
  ...
  },
  {
    ...
    mockArtifact: {
      ...
      html:
        '<!doctype html><html><body><main data-gd-id="hero-section"><h1 data-gd-id="hero-title" data-screen-label="Hero title">Prototype headline</h1><p data-gd-id="hero-copy">Preview copy for comment mode.</p></main></body></html>',
    },
    notes: [
