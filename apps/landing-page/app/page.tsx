/*
 * Galyarder Design — Atelier Zero landing page.
 *
 * Mirrors `design-templates/galyarder-design-landing/example.html` 1:1. When the canonical
...
// Canonical project URLs. Keep in sync with design-templates/galyarder-design-landing/example.html.
//
...
const REPO = 'https://github.com/galyarderlabs/galyarder-design';
...
const DISCORD = 'https://github.com/galyarderlabs/galyarder-design/discussions';
...
export default function Page({
  ...
  return (
    <>
      ...
      <div className='side-rail right' data-gd-id='rail-right'>
        <span className='rail-text'>
          Galyarder Design — Vol. 01 · Issue Nº 26 · Apache-2.0
        </span>
      </div>
      <div className='side-rail left' data-gd-id='rail-left'>
        <span className='rail-text'>
      ...
      <div className='shell'>
        {/* ====== TOP METADATA STRIP ====== */}
        <div className='topbar' data-gd-id='topbar'>
        ...
        <section className='hero' id='top' data-gd-id='hero'>
          <div className='container hero-grid'>
            ...
            <div className='hero-art' data-reveal='scale'>
              ...
              <span className='annot annot-tl coord'>FIG. 01 / GD-26</span>
              ...
              <span className='annot annot-br'>
                Composed in{NBSP}
                <span style={{ color: 'var(--coral)' }}>Galyarder Design</span>
              </span>
              <img
                src={heroImage}
        ...
        {/* ====== ABOUT ====== */}
        <section className='about' data-gd-id='about'>
          <div className='container'>
            <div className='sec-rule'>
              ...
              <span className='meta-grp'>
                ...
                <span>Galyarder Design / Volume 01</span>
              </span>
              <span>002 / 008</span>
            </div>
            ...
            <div className='capabilities-grid'>
              <div className='capabilities-art' data-reveal='left'>
                ...
                <div className='ribbon'>
                  <b>GALYARDER DESIGN</b>
                  {NBSP}·{NBSP}CAPABILITIES MATRIX{NBSP}·{NBSP}GD/26
                </div>
              </div>
        ...
        {/* ====== LABS ====== */}
        <section className='labs' id='labs' data-gd-id='labs'>
          <div className='container'>
            <div className='sec-rule'>
        ...
        {/* ====== METHOD ====== */}
        <section className='method' data-gd-id='method'>
          <div className='container'>
            <div className='sec-rule'>
            ...
            <div className='method-foot'>
              ...
              <div className='right'>
                <a className='method-repo-link' href={REPO} {...ext}>
                  <b>github.com/galyarderlabs/galyarder-design</b>
                </a>
        ...
        {/* ====== SELECTED WORK ====== */}
        <section className='tight' data-gd-id='work'>
          <div className='work'>
            <div className='work-rule'>
              ...
              <span style={{ display: 'inline-flex', gap: 24 }}>
                ...
                <span>Edited by Galyarder Design</span>
              </span>
              <span>006 / 008</span>
            </div>
        ...
        <section className='testimonial' data-gd-id='testimonial'>
          <div className='container'>
            <div className='sec-rule'>
          ...
          <div className='container'>
            ...
            <div className='cta-grid'>
              ...
              <div className='cta-art' data-reveal='right'>
                ...
                <div className='ribbon'>
                  GALYARDER DESIGN{NBSP}·{NBSP}FIN.
                </div>
              </div>
            </div>
          </div>
        ...
        <footer data-gd-id='footer'>
          <div className='container'>
            <div className='foot-grid'>
              <div className='foot-brand'>
                ...
                <a
                  className='foot-cta'
                  href={REPO_RELEASES}
                  aria-label='Download the Galyarder Design desktop app'
                  {...ext}
                >
            ...
            <div className='foot-bottom'>
              <span>
                <span className='pulse' />●{' '}
                <b style={{ color: 'var(--ink)' }}>Galyarder Design</b> · Apache-2.0
