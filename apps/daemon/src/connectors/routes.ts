...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · Galyarder Design</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="Galyarder Design">
        <span class="brand-mark" aria-hidden="true">GD</span>
        <span class="brand-title">Galyarder Design</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in Galyarder Design.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        const message = { type: 'galyarder-design:connector-connected', connectorId, connectorLabel };
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to Galyarder Design.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to Galyarder Design.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to Galyarder Design.';
        }
