...
Auto-generated package guide for Galyarder Design agents and reviewers.
...
- Use the normalized GD tokens as the source of truth. This bundled package is not source-repository verbatim evidence.
