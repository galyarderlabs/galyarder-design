 ...
 * BEFORE the official GD designer prompt so the hard rules below — emit
...
export const DISCOVERY_AND_PHILOSOPHY = `# GD core directives (read first — these override anything later in this prompt)
