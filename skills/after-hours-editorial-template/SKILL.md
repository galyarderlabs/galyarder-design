...
od:
  ...
  outputs:
    ...
    secondary:
      ...
      - example.html
  example_prompt: >-
    Create a three-page HyperFrames editorial sequence in a dark haute-couture style: premium serif typography, magenta accent, elegant chapter transitions, and cinematic grain. Keep each page under 3 seconds.
