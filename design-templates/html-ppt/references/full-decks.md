...
## 1. xhs-white-editorial — White editorial magazine

- **Source inspiration:** the v2 white-background RedNote (xhs) post layouts and the testing-and-safety v2 deck.
...
- **When to use:** dual-purpose RedNote image post + horizontal deck; dense text with strong emphasis; Chinese-first audience.
- **Path:** `templates/full-decks/xhs-white-editorial/index.html`

## 2. graphify-dark-graph — Dark knowledge graph

- **Source inspiration:** the Graphify dark-mode graph deck.
...
- **Source inspiration:** the Karpathy knowledge-base architecture-diagram v2 deck.
...
- **Source inspiration:** the Hermes-agent record and Hermes-vs-OpenClaw decks.
...
- **Source inspiration:** the Obsidian + Claude slides deck.
...
## 6. testing-safety-alert — Red-and-amber hazard

- **Source inspiration:** the AI testing-and-safety v2 deck.
...
- **Source inspiration:** the Obsidian-skills RedNote post and shared pastel patterns from the v2 white-background series.
...
- **Source inspiration:** the Karpathy knowledge-base "arrow-key edition" minimal deck.
...
| 11 | `tech-sharing`     | 8  | GitHub-dark, JetBrains Mono, terminal code blocks, agenda + Q&A | Tech sharing, internal tech talk, conference talk |
...
| 13 | `xhs-post`         | 9  | **3:4 @ 810×1080**, warm pastel, dashed sticker cards, page dots | RedNote (xhs) image post, Instagram carousel |
| 14 | `course-module`    | 7  | Warm paper + Playfair serif, persistent left sidebar of learning objectives, MCQ self-check | Course module, online course, workshop module |
| 15 | `presenter-mode-reveal` 🎤 | 6  | **Built for presenter mode** · tokyo-night default · 5 themes via the T key · each page ships with a 150–300 word speaker script example | **Tech sharing / talks / courses** — anywhere you want to press S and read a speaker script ✨ |
...
> 🎤 **For any speaking scenario (tech sharing / course / pitch), reach for `presenter-mode-reveal`** — or follow [presenter-mode.md](./presenter-mode.md) and add `<aside class="notes">` speaker scripts to any other template.
