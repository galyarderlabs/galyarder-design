...
export const SIDECAR_ENV = Object.freeze({
  BASE: "GD_SIDECAR_BASE",
  DAEMON_CLI_PATH: "GD_DAEMON_CLI_PATH",
  DAEMON_PORT: "GD_PORT",
  IPC_BASE: "GD_SIDECAR_IPC_BASE",
  IPC_PATH: "GD_SIDECAR_IPC_PATH",
  NAMESPACE: "GD_SIDECAR_NAMESPACE",
  SOURCE: "GD_SIDECAR_SOURCE",
  TOOLS_DEV_PARENT_PID: "GD_TOOLS_DEV_PARENT_PID",
  WEB_DIST_DIR: "GD_WEB_DIST_DIR",
  WEB_PORT: "GD_WEB_PORT",
  WEB_TSCONFIG_PATH: "GD_WEB_TSCONFIG_PATH",
} as const);
...
export const SIDECAR_STAMP_FLAGS = Object.freeze({
  ...
  ipc: "--gd-stamp-ipc",
  mode: "--gd-stamp-mode",
  namespace: "--gd-stamp-namespace",
  source: "--gd-stamp-source",
} as const);
...
export const SIDECAR_DEFAULTS = Object.freeze({
  host: "127.0.0.1",
  ipcBase: "/tmp/galyarder-design/ipc",
  namespace: "default",
  projectTmpDirName: ".tmp",
  windowsPipePrefix: "galyarder-design",
} as const);
...
export type DaemonStatusSnapshot = {
   ...
   * was spawned without `GD_REQUIRE_DESKTOP_AUTH=1` (the split-start
...
export type GalyarderDesignSidecarContract = {
...
export const GALYARDER_DESIGN_SIDECAR_CONTRACT = Object.freeze({
  appKeys: APP_KEYS,
...
} as const satisfies GalyarderDesignSidecarContract);
