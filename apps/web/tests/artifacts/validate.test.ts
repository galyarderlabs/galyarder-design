...
describe('validateHtmlArtifact', () => {
  ...
  it('rejects a one-line prose summary (the #50 phantom-artifact case)', () => {
    // UTF-8 / CJK fixture; Chinese-language prose summary verifies the
    // validator rejects pointer-style summaries in any language.
  ...
  it('rejects a long prose blob that lacks any HTML structural markers', () => {
    // UTF-8 / CJK fixture; verifies long Chinese-language prose without
    // any HTML tags is rejected by the validator regardless of byte size.
