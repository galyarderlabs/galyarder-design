...
description: Presenter-mode-focused deck — tokyo-night default theme, 5 themes via the T key, every slide ships with a 150–300 word verbatim speaker script (`<aside class="notes">`), press S to open the popup (CURRENT / NEXT / SCRIPT / TIMER magnetic cards). Built for tech talks, public speaking, and class lectures where you want a teleprompter or are worried about losing your line.
triggers:
  - "presenter mode"
  - "presenter view"
  - "verbatim script"
...
od:
  ...
  speaker_notes: true
  animations: true
  example_prompt: "Use the html-ppt-presenter-mode template to build a deck with verbatim speaker scripts. First confirm: the talk topic, length (about 2-3 minutes per slide), and target audience. Then write a conversational 150–300 word script per slide (cue prompts, not full prose). Press S to open the presenter popup."
---
