// Use Galyarder Design Everywhere — modal entry that documents Galyarder Design's
...
interface Props {
  ...
  daemonUrl?: string;
  /** Optional Galyarder Design version string surfaced in the agent guide header. */
  versionHint?: string;
}
