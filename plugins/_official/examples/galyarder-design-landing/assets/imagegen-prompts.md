...
Use only when the model copy must be in another language; otherwise prefer
English for legibility. Keep verbatim text short.

```text
Generate a 16:9 horizontal web design mockup for a high-end creative AI
studio site: modern Swiss editorial layout, Bauhaus geometry, classical
plaster sculpture collage, minimal architecture, handmade paper texture,
fine engineering-drawing line marks.

Brand text:    "<BRAND_NAME>"
Navigation:    "<NAV_1>", "<NAV_2>", "<NAV_3>", "<NAV_4>"
Eyebrow:       "<EYEBROW>"
Headline must render verbatim:        "<HEADLINE>"
Italic emphasis (italic serif):       "<EMPHASIS>"
Body copy must render verbatim:       "<BODY>"
Buttons:       "<CTA_1>", "<CTA_2>"

Main subject: <subject description>
Texture motifs: <sky / stone / vegetation / human figure / eye / mountains / water / UI screenshots>
Composition:  <text-left/image-right | image-left/text-right | full-width
              headline + horizontal cards | centered collage | timeline
              split>
Color: warm ivory paper, black text, limestone / concrete grey, charcoal,
desaturated coral accent, occasional mustard yellow or pale sky blue.

Constraints: type must be crisp and readable; do not add extra random
text; no watermarks, no cartoon style, no neon, no heavy shadows, no
clichéd tech blue/purple gradients.
```
