...
describe('renderMarkdownToSafeHtml', () => {
  ...
  it('renders a GFM pipe table with header and body rows', () => {
    // UTF-8 / CJK fixture; CJK column headers and cells exercise the
    // markdown table renderer with non-ASCII content. Translations:
    // 字段 = field, 类型 = type, 说明 = description, 主键 = primary key,
    // 简称 = short name.
    const md = [
      '| 字段 | 类型 | 说明 |',
      '|---|---|---|',
