...
triggers:
  ...
  - "Cream base pastel card data report"
od:
  mode: template
  surface: video
  type: hyperframes
  ...
  outputs:
    ...
    secondary:
      ...
      - example.html
  example_prompt: >-
    Create an editorial Field Notes style report with three insight cards, key metrics blocks, and a retention line chart in one polished single-file HTML page.
