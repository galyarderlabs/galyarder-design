...
import type { DegradedReason, PanelEvent, PanelistRole } from '@galyarder-design/contracts/critique';
import { CRITIQUE_PROTOCOL_VERSION } from '@galyarder-design/contracts/critique';
