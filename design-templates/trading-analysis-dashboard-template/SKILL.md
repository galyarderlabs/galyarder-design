...
triggers:
  ...
  - "Transaction analytics panel template"
...
od:
  ...
  outputs:
    ...
    secondary:
      ...
      - example.html
  example_prompt: >-
    Create a Wall-Street-grade trading analysis dashboard template with a left rail, risk cockpit, market charts, live/demo mode, and realistic dense data. Keep it single-file HTML.
