# 🔥 Galyarder Design 0.8.0-preview — Design's old world ends here. Help us build the new one.

> **Status:** Now landed on `main` · 0.8.0 release tag coming up · feedback still wanted
> **Branch:** [`main`](https://github.com/galyarderlabs/galyarder-design/tree/main) — everything below tracks `main`
...
- **♻️ Plugins create plugins.** GD CLI wraps GitHub CLI, so an agent can clone the repo, scaffold a plugin, and open a PR — for you, *or for itself*. The loop is closed: the engine grows itself, in public, with you in the loop.
...
- 🍎 macOS (Apple Silicon): [galyarder-design-0.8.0-preview.2-mac-arm64.dmg](https://releases.galyarder-design.dev/preview/versions/0.8.0-preview.2/galyarder-design-0.8.0-preview.2-mac-arm64.dmg)
- 🍎 macOS (Intel): [galyarder-design-0.8.0-preview.2-mac-x64.dmg](https://releases.galyarder-design.dev/preview/versions/0.8.0-preview.2/galyarder-design-0.8.0-preview.2-mac-x64.dmg)
- 🪟 Windows: [galyarder-design-0.8.0-preview.2-win-x64-setup.exe](https://releases.galyarder-design.dev/preview/versions/0.8.0-preview.2/galyarder-design-0.8.0-preview.2-win-x64-setup.exe)
- 🐧 Linux: *coming soon*
...
→ [**Open a 0.8.0 preview feedback issue**](https://github.com/galyarderlabs/galyarder-design/issues/new?template=preview-v0.8.0-feedback.yml) — bugs, suggestions, first impressions, all welcome. The team watches [all open issues](https://github.com/galyarderlabs/galyarder-design/issues).
...
→ [**Join the Galyarder Design preview Discord**](https://github.com/galyarderlabs/galyarder-design/discussions)
