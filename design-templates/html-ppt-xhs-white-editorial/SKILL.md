...
description: Editorial white magazine deck — styled with pure white backgrounds + a 10-color rainbow top header bar, 80-110px large display titles, purple-blue-green-orange-pink gradient headings, soft pastel macaron cards (Pink, Purple, Blue, Green, Orange), dark pill labels (.focus), and blockquotes. Versatile for both 3:4 vertical posts and standard horizontal presentation decks.
triggers:
...
od:
  ...
  animations: true
  example_prompt: >-
    Build an editorial white slide deck using the html-ppt-xhs-white-editorial template. Key details: 80-110px display titles, rainbow top headers, macaron cards, and solid dark pill labels. First ask for my topic and target audience, then generate an 8-12 page deck.
---
