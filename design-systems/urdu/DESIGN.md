...
<button class="button button-primary">
  <span lang="ur">Confirm <!-- placeholder; real artifact ships Urdu --></span>
</button>
```
...
<button class="button button-secondary">
  <span lang="ur">Cancel <!-- placeholder; real artifact ships Urdu --></span>
</button>
```
...
<button class="button button-primary">
  ...
  <span lang="ur">Send <!-- placeholder; real artifact ships Urdu --></span>
</button>
...
<div class="form-group">
  <label lang="ur" for="username">Username <!-- placeholder; real artifact ships Urdu --></label>
  <input 
    id="username" 
    type="text" 
    class="input" 
    placeholder="Enter your username (placeholder; real artifact ships Urdu)"
    lang="ur"
    dir="rtl"
  />
</div>
...
<input placeholder="Username (Urdu placeholder)" />

<!-- ✅ GOOD: Label + placeholder both present -->
<label for="username">Username (Urdu placeholder)</label>
<input id="username" placeholder="e.g. Ahmad Ali (Urdu placeholder)" />

<!-- ✅ EXCELLENT: Label + aria-label for screen readers -->
<label for="username" lang="ur">Username (Urdu placeholder)</label>
<input 
  id="username" 
  aria-label="Enter your username (Urdu placeholder)"
  placeholder="Ahmad Ali (Urdu placeholder)"
/>
```
...
```html
<div class="card">
  <h3 lang="ur">Card title (Urdu placeholder)</h3>
  <p lang="ur">Card content (Urdu placeholder).</p>
</div>
```
...
```html
<a href="#" lang="ur">Read more (Urdu placeholder)</a>
```
...
```html
<label for="email" lang="ur">Email (Urdu placeholder)</label>
<input id="email" type="email" placeholder="name@example.com" />

<button class="icon-button" aria-label="Search (Urdu placeholder)">
  <icon class="icon-search"></icon>
</button>

<label for="pass" lang="ur">Password (Urdu placeholder)</label>
<input id="pass" type="password" aria-describedby="pass-hint" />
<p id="pass-hint" lang="ur">At least 8 characters (Urdu placeholder).</p>
...
<html lang="ur" dir="rtl">
  ...
  <body>
    <h1 lang="ur">Welcome (Urdu placeholder)</h1>
  </body>
</html>
```
...
```urdu
✅ Sorry, your request could not complete. Please try again. (Urdu placeholder)
❌ Error (Urdu placeholder)
```
...
```urdu
✅ Something went wrong! Please try again. (Urdu placeholder)
❌ Error 503
```
...
```urdu
✅ API error in response: [error_code] (Urdu placeholder)
❌ Hey, something went wrong (Urdu placeholder)
```
...
```html
<!-- ✅ Correct -->
<span lang="ur">₨ 25,000 <!-- Urdu numerals in real artifact --></span>
...
|---------|------|---------|
| "Submit" | Localised verbs for "Submit" / "Submit (form)" | Form action |
| "Cancel" | Localised verbs for "Cancel" / "Go back" | Dismissal |
| "Loading..." | Localised "Loading..." copy | Wait state |
| "Error occurred" | Localised "Sorry, something went wrong." copy | Error state |
| "No results" | Localised "No results found" copy | Empty state |
...
- **Truncate text with ellipsis in RTL:** `text-overflow: ellipsis` reads backwards. Use expand-button or full text instead.
  ...
  <p style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
    This is very long text... (Urdu placeholder)
  </p>
  
  <!-- ✅ GOOD: Full text or expand-button -->
  <details>
    <summary lang="ur">See more (Urdu placeholder)</summary>
    <p lang="ur">This long text continues; click to expand (Urdu placeholder).</p>
  </details>
  ```
...
<body>
  <div class="container">
    <h1>Welcome — Urdu Modern Quick Start (Urdu placeholder)</h1>
    
    <p>
      This is a complete example showing how to use the Urdu Modern design system. (Urdu placeholder)
    </p>
    
    <p>
      Here are some key features (Urdu placeholder):
    </p>
    
    <ul style="margin-block-start: var(--space-md); margin-inline-start: var(--space-lg);">
      <li>Nastaliq font is automatically optimised for RTL (Urdu placeholder)</li>
      <li>Color spots <code>#0F595E</code> are tuned for informational warnings (Urdu placeholder)</li>
      <li>All Urdu text is marked with <code>lang="ur"</code> (Urdu placeholder)</li>
    </ul>
    
    <div class="code-block">
      &lt;button class="button-primary"&gt;Confirm (Urdu placeholder)&lt;/button&gt;
    </div>
    
    <div class="button-group">
      <button class="button button-primary">Confirm (Urdu placeholder)</button>
      <button class="button button-secondary">Cancel (Urdu placeholder)</button>
    </div>
  </div>
</body>
</html>
...
2. **Wrap Urdu text:** All Urdu strings wrapped in semantic tags with `lang="ur"`:
   ```html
   <h1 lang="ur">This is a heading (Urdu placeholder)</h1>
   <p lang="ur">Body text here (Urdu placeholder).</p>
   ```
...
## Design System Metadata (For GD Daemon)
