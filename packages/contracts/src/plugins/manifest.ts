...
// `galyarder-design.json` schema (v1). Mirrors docs/schemas/galyarder-design.plugin.v1.json
...
export const GALYARDER_DESIGN_PLUGIN_SPEC_VERSION = '1.0.0';

export const GalyarderDesignSpecVersionSchema = z.string().min(1);
...
export const PluginManifestSchema = z.object({
  ...
  specVersion: GalyarderDesignSpecVersionSchema.optional(),
