...
describe('PluginDetailsModal common metadata coverage', () => {
  ...
  it('routes official plugin author and source links to the Galyarder Design repo', () => {
    const html = render(
      pluginWithMeta({
    ...
    expect(html).toContain('href="https://github.com/galyarderlabs/galyarder-design"');
    expect(html).toContain('galyarderlabs/galyarder-design');
