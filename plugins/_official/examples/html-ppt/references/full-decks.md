...
## 1. xhs-white-editorial — White-paper editorial

- **Source inspiration:** `20260409 knowledge-base-upgrade/rednote-image-text/v2-white-bg/slide_01_cover.html` + `20260412-ai-testing-and-safety/html/xhs-ai-testing-safety-v2.html`
...
- **When to use:** dual-purpose RedNote image + horizontal deck; dense text with strong emphasis; editorial-leaning audiences.
...
- **Source inspiration:** `20260405-Karpathy-knowledge-base/20260405 architecture-v2.html`
...
- **Source inspiration:** `20260412-obsidian-skills/html/xhs-obsidian-skills.html` + pastel patterns shared with the `20260409` v2 white-bg edition
...
- **Source inspiration:** `20260405-Karpathy-knowledge-base/20260405 demo-slides-arrow-keys.html`
...
| 11 | `tech-sharing`     | 8  | GitHub-dark, JetBrains Mono, terminal code blocks, agenda + Q&A | Tech talks, internal engineering shares, conference talks |
| 12 | `weekly-report`    | 7  | Corporate clarity, 8-cell KPI grid, shipped list, 8-week bar chart, next-week table | Weekly reports, team status updates, business reviews |
| 13 | `xhs-post`         | 9  | **3:4 @ 810×1080**, warm pastel, dashed sticker cards, page dots | RedNote image-text post, Instagram carousel |
| 14 | `course-module`    | 7  | Warm paper + Playfair serif, persistent left sidebar of learning objectives, MCQ self-check | Teaching modules, online courses, workshop modules |
| 15 | `presenter-mode-reveal` 🎤 | 6  | **Built for presenter mode** · tokyo-night default · 5 themes (press T to cycle) · every slide ships a 150–300 word verbatim-script sample | **Tech talks / keynotes / courses** — anywhere you press S to read the script ✨ |
...
> 🎤 **For any speaking scenario (tech talks / courses / roadshows), reach for `presenter-mode-reveal`** — or follow [presenter-mode.md](./presenter-mode.md) to add `<aside class="notes">` verbatim scripts to any other template.
