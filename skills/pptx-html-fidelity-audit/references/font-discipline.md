...
For mixed-script runs (e.g. a Latin emphasis span followed by CJK text), split into
...
> (with sample Devanagari conjunct clusters, Thai 4-mark tone sequences, and stacked
