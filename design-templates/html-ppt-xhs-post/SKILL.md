...
description: Xiaohongshu & Instagram-style 9-page 3:4 vertical slider (810×1080) — featuring warm pastel palettes, dashed sticker cards, and dot pagination at the bottom. Perfect for vertical slides, Instagram carousels, or brand showcase posts.
triggers:
  - "Xiaohongshu"
  - "xhs"
  - "xhs post"
...
od:
  ...
  animations: true
  example_prompt: >-
    Create a 9-slide vertical presentation (3:4 aspect ratio, 810×1080) using the html-ppt-xhs-post template. First ask for my theme, then help me structure the cover slide, 7 content slides, and a call-to-action outro. Each slide includes a title, body paragraph, and custom keyword stickers.
---
# HTML PPT · Xiaohongshu Graphics
