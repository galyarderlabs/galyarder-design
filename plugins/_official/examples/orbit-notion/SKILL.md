...
8. **Callout block** — required. `gray bg`, 16px padding, rounded 6px,
   ...
   *"Eli, you have 3 unread comments from yesterday — take a look before the Wednesday standup?"*
...
| Use lorem ipsum | Write real-shaped Notion copy: doc titles like `Q3 OKR`, `Onboarding Doc`, `Team weekly`; people like Marie / Bob / Lily; comments like "Need your sign-off on this section" |
