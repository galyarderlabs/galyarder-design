...
description: |
  ...
  "Nintendo-style", "sprite sheet animation", "pixel art animation", or "retro animation".
triggers:
  - "sprite animation"
  - "pixel art animation"
  - "8-bit explainer"
...
4. **Top bar** — small mono row:
   - Left: title slug ("Show/Program" or "EP. 01 / NINTENDO")
...
5. **Subject animations** — at least three independent looping animations
   ...
   - **Kinetic kana**: 1–2 Japanese / kanji characters that fade-and-slide
     in sync with the bob (e.g. "Flower" — *hana* — flower).
