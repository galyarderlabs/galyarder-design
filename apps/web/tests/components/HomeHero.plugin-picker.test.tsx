...
describe('HomeHero plugin picker', () => {
  ...
  it('does not submit while an IME composition is confirming text with Enter', () => {
    // CJK fixture; '做一个中文官网' (Chinese for "make a Chinese-language
    // marketing site") drives the IME composition path through HomeHero
    // — the test verifies Enter does not auto-submit while composing.
