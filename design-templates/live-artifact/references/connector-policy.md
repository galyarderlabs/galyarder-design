...
- Tool endpoints require the injected `GD_TOOL_TOKEN`; do not invent or pass `projectId`.
...
```json
{
  ...
  "input": { "owner": "galyarder-design", "repo": "galyarder-design" },
  "connector": {
