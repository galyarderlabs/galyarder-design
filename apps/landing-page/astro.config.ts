...
const editorialPaperTheme: ShikiThemeObject = {
  name: 'galyarder-design-editorial',
  type: 'light',
  colors: {
...
//
// `galyarder-design.ai` is the live domain bound to the Cloudflare Pages
// project (`galyarder-design-landing`); the env override exists so preview
...
const site = process.env.GD_LANDING_SITE ?? 'https://galyarder-design.ai';
const locales = ['en', 'id', 'de', 'pt-BR', 'es-ES', 'ru', 'fa', 'ar', 'ja', 'ko', 'pl', 'hu', 'fr', 'uk', 'tr', 'th', 'it'];
const changefreq = {
