...
description: |
  Social Media Matrix Tracker Dashboard Template.
...
triggers:
  ...
  - "Social media matrix kanban template"
...
od:
  ...
  outputs:
    ...
    secondary:
      ...
      - example.html
  example_prompt: >-
    Create a social media matrix tracker dashboard template using my DESIGN.md. Keep the cinematic glassmorphism style, multi-chart analytics sections, hover tooltips, pin/drag range analysis, and light/dark switching.
