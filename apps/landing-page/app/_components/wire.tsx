 ...
 *
 *   GET https://api.github.com/repos/galyarderlabs/galyarder-design/contributors
 *
...
// canonical wire row in `design-templates/galyarder-design-landing/example.html` so
...
const FALLBACK: ReadonlyArray<Contributor> = [
  ...
  { handle: 'galyarderlabs', role: 'studio', href: 'https://github.com/galyarderlabs' },
  TRAILING_CTA,
];
