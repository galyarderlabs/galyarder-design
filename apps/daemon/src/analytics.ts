...
// HTTP headers (see x-gd-analytics-* constants in @galyarder-design/contracts);
...
// somehow attaches x-gd-analytics-* headers to a request after the user
...
// path; the canonical hash lives in @galyarder-design/contracts/analytics so
