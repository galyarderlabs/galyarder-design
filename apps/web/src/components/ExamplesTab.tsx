...
export function ExamplesTab({ skills: rawSkills, onUsePrompt }: Props) {
  ...
  // `gd.preview.type` isn't `html` (image / markdown / …) without the
            ...
            views={[
              {
                ...
                // Skills declared with a non-html `gd.preview.type` ship
...
function ExampleCard({
  ...
  // `gd.preview.type` is image / markdown / …) — the user gets a
