 ...
 * `pnpm --filter @galyarder-design/web test` pipeline picks it up; no new
...
import { CRITIQUE_SSE_EVENT_NAMES, PANELIST_ROLES } from '@galyarder-design/contracts/critique';
