...
od:
  ...
  speaker_notes: true
  animations: true
  example_prompt: "Use the html-ppt-tech-sharing template to build an 8-slide tech-talk deck. First confirm: the topic, the audience (teammates / community / customers), and whether to include code snippets and benchmarks. GitHub dark theme + JetBrains Mono, with agenda and Q&A slides ready."
---
