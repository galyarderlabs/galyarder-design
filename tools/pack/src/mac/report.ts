...
export async function collectMacSizeReport(
  ...
  return {
    ...
    tracked: {
      ...
      webNextCacheBytes: await sizePathBytes(join(appNodeModulesRoot, "@galyarder-design", "web", ".next", "cache")),
      webPackageBytes: await sizePathBytes(join(appNodeModulesRoot, "@galyarder-design", "web")),
      webPackageStandaloneBytes: await sizePathBytes(join(appNodeModulesRoot, "@galyarder-design", "web", ".next", "standalone")),
    },
