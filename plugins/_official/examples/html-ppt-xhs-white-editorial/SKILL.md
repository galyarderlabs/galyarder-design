...
description: White-paper editorial deck — pure-white background + a 10-color rainbow bar at the top, 80–110px display headlines, gradient text (purple→blue→green→orange→pink), macaron soft-card stack (pink/purple/blue/green/orange), black-on-white .focus pills, and large pull quotes. Doubles as a RedNote photo set and a wide-format slide deck.
triggers:
  - "white editorial"
  - "magazine style"
  - "xhs editorial"
  - "white editorial deck"
...
od:
  ...
  speaker_notes: true
  animations: true
  example_prompt: "Use the html-ppt-xhs-white-editorial template for a white-paper editorial deck. Highlights: 80-110px display headlines, rainbow top bar, macaron soft cards, black-on-white .focus pills. First share the topic and audience, then write 8–12 slides."
---
# HTML PPT · White-paper editorial
