...
od:
  ...
  animations: true
  example_prompt: >-
    Help me create an 8-slide technical sharing presentation using the html-ppt-tech-sharing template. First confirm: presentation topic, target audience (colleagues, developer community, or customers), and if you want to include code blocks or benchmark charts. Uses a clean dark GitHub theme and JetBrains Monospace typography, with agenda and Q&A templates prepared.
---
