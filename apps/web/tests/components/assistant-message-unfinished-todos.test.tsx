  ...
  it('surfaces generated plugin next actions in the latest assistant turn', async () => {
    ...
    render(
      <AssistantMessage
          ...
          ...messageWithEvents([
            {
              ...
              id: 'write-manifest',
              name: 'Write',
              input: { path: 'galyarder-design.json' },
            },
            {
              kind: 'tool_result',
        ...
        projectId="project-1"
        projectFiles={[
          workspaceFile('generated-plugin/galyarder-design.json'),
    ...
    expect(onOpen).toHaveBeenCalledWith('generated-plugin/galyarder-design.json');
  });
});
