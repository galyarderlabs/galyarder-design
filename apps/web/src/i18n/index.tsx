...
import { getGalyarderDesignHost } from '@galyarder-design/host';
...
// through `getGalyarderDesignHost` rather than reading the bridge global by
...
function readDesktopHostOsLocale(): string | undefined {
  ...
  const host = getGalyarderDesignHost();
