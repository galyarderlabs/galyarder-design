...
> "Make me an 8-slide tech sharing deck, cyberpunk theme"
> "Turn this outline into a pitch deck"
> "Build a 9-card RedNote post, white background, soft style"
...
**Extracted looks**
- `xhs-white-editorial` — RedNote (xhs) white editorial magazine
- `graphify-dark-graph` — dark base + force-directed knowledge graph
...
- `testing-safety-alert` — red / amber hazard
- `xhs-pastel-card` — soft macaron RedNote post
- `dir-key-nav-minimal` — arrow-key minimal
