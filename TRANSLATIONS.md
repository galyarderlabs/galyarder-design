...
> **Quick start for contributors:** This guide helps you add a new language translation to Galyarder Design in ~2 hours instead of ~8 hours. Follow the checklist, avoid common mistakes, and ship your PR with confidence.
...
- Regional variants when needed: `pt-BR`, `es-ES`
- Use hyphens, not underscores: `pt-BR` ✅ not `pt_BR` ❌
...
- ✅ Alt text: `alt="Galyarder Design banner"`
...
- ❌ Brand names: "Galyarder Design", "Claude Code"
...
**Don't forget to update test fixtures:** Add your locale code to `EXPECTED_LOCALES` in `apps/web/tests/i18n/locales.test.ts` and add a `LOCALE_LABEL` assertion (e.g., `expect(LOCALE_LABEL.it).toBe('Italiano');`). Run `pnpm --filter @galyarder-design/web test` to verify.
...
Galyarder Design currently supports **18 languages** across different surfaces:
...
2. **Update [`apps/web/src/i18n/types.ts`](apps/web/src/i18n/types.ts):**
   ...
   - Add a `LOCALE_LABEL[<code>]` entry — use the **native name** of the language (e.g. the language's own self-name, not the code like `it` or `ja`)
...
6. **Update the language switcher in EVERY root README** (line ~30 of each `README*.md`):
   ...
   **Standard order (text labels are language native-names, shown here as English placeholders):**
   ```html
   <p align="center"><a href="README.md">English</a> · <a href="README.es.md">Spanish</a> · <a href="README.pt-BR.md">Portuguese (Brazil)</a> · <a href="README.de.md">German</a> · <a href="README.fr.md">French</a> · <a href="README.ko.md">Korean</a> · <a href="README.ja-JP.md">Japanese</a> · <a href="README.ar.md">Arabic</a> · <a href="README.ru.md">Russian</a> · <a href="README.uk.md">Ukrainian</a> · <a href="README.tr.md">Turkish</a> · <a href="README.it.md">Italian</a></p>
   ```
...
9. **Run checks:**
   ...
   pnpm --filter @galyarder-design/web test  # Covers locale/content drift tests
   ```
...
- ✅ Alt text in images: `alt="Galyarder Design banner"` → `alt="Banner di Galyarder Design"`
...
- ❌ Brand names: "Galyarder Design", "Claude Code", "Anthropic", "Vercel"
...
- Use the English term with a brief explanation in parentheses on first use if no standard translation exists:
  ```
  Galyarder Design è un'alternativa open-source (codice aperto) a Claude Design.
  ```
- For regional variants (e.g., pt-BR vs pt-PT), choose the most widely understood variant for your target audience
...
```markdown
<!-- English -->
<a href="https://github.com/galyarderlabs/galyarder-design/discussions"><img alt="Discord" src="https://img.shields.io/badge/discord-join-5865F2?style=flat-square&logo=discord&logoColor=white" /></a>

<!-- Italian -->
<a href="https://github.com/galyarderlabs/galyarder-design/discussions"><img alt="Discord" src="https://img.shields.io/badge/discord-unisciti-5865F2?style=flat-square&logo=discord&logoColor=white" /></a>
```
...
- Galyarder Design, Claude Code, Claude Design
...
**Example (Arabic translation of "Galyarder Design is the open-source alternative to Claude Design", placeholder shown as English):**
```markdown
Galyarder Design is the open-source alternative to Claude Design
```
...
```markdown
## Summary
Adds [Language] translation for Galyarder Design documentation.
...
```markdown
<!-- README: RTL languages flow automatically (e.g. Arabic translation of the tagline) -->
Galyarder Design is the open-source alternative to Claude Design
...
- Japanese: localized date format (e.g. year/month/day with native era markers)
...
- **Questions?** Open a [GitHub Discussion](https://github.com/galyarderlabs/galyarder-design/discussions)
- **Found an issue?** Open a [GitHub Issue](https://github.com/galyarderlabs/galyarder-design/issues)
- **Want to chat?** Join our [Discord](https://github.com/galyarderlabs/galyarder-design/discussions)
- **Need a review?** Tag `@galyarderlabs/maintainers` in your PR
...
If you have an opinion on any of the above, open an issue or comment on [#195](https://github.com/galyarderlabs/galyarder-design/issues/195).
...
- **README template-driven generation** (e.g. [NRG](https://github.com/nanolaba/readme-generator), custom `.src.md` build scripts, All Contributors-style tooling). Re-evaluate once the project hits ≥15 locales **or** README structural edits become more frequent than monthly. Discussion in [#195](https://github.com/galyarderlabs/galyarder-design/issues/195): template-driven generation solves the "update line 27 in 10 README variants" brittleness, but forces a shared structure that today's locale variants intentionally diverge from (the pt-BR / pt-PT precedent shows content-level — not just translation-level — differences are sometimes intentional). Worth revisiting once locale voice is more settled or the manual-update cost grows.
...
Every translation makes Galyarder Design accessible to more developers worldwide.

**Current contributors:**
- See [Contributors](https://github.com/galyarderlabs/galyarder-design/graphs/contributors) for the full list

---

**Ready to contribute?** Pick a language, follow the [Quick Start](#-quick-start-adding-your-language-in-5-steps), and submit your PR. We can't wait to see Galyarder Design in your language! 🚀
