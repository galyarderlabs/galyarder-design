...
export interface ProjectMetadata {
  ...
  // absolute path instead of .gd/projects/<id>/. GD reads and writes
  ...
  // the import request carried a valid `X-GD-Desktop-Import-Token`
...
// (after realpath canonicalization) and GD reads/writes directly inside it.
// The user owns version control; GD does not snapshot or copy.
