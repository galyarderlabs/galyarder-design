...
(function () {
  ...
  ready(function () {
     ...
     *   SCRIPT   — large speaker notes (verbatim script)
    ...
    function openPresenterWindow() {
      ...
      if (!presenterWin) {
        alert('Please allow popup windows to use the presenter view');
        return;
      }
...
<div class="hint-bar">
  ...
  <span style="color:#6e7681">Drag the card header to move &middot; drag the bottom-right corner to resize</span>
...
(function(){
  ...
  function update(n) {
    ...
    notesBody.innerHTML = note || '<span class="empty">(No speaker script for this slide yet)</span>';
  ...
  notesBody.innerHTML = slideMeta[idx].notes || '<span class="empty">(No speaker script for this slide yet)</span>';
