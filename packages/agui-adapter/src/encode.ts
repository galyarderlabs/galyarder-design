// Map an Galyarder Design native event onto the AG-UI canonical wire shape.
//
// The GD native union covers more than AG-UI cares about (e.g. internal
...
// The PersistedAgentEvent variants GD emits on a run's SSE stream.
...
export interface EncodeContext {
  // The run's id; GD may have it on the event already, but the daemon
  ...
  seq?: number;
  // Wall-clock fallback. The encoder uses this when the GD event
