...
LangString GD_REMOVE_LOCAL_DATA_TITLE 1033 "Remove local data"

LangString GD_REMOVE_LOCAL_DATA_HINT 1033 "Choose whether the uninstaller should remove Galyarder Design data stored on this computer."

LangString GD_REMOVE_LOCAL_DATA_CHECKBOX 1033 "Remove local Galyarder Design data:"

!macro customUnWelcomePage
  !insertmacro MUI_UNPAGE_WELCOME
  UninstPage custom un.GalyarderDesignLocalDataPage un.GalyarderDesignLocalDataPageLeave
!macroend

Function un.GalyarderDesignLocalDataPage
  ...
  \${NSD_CreateLabel} 0 0 100% 24u "$(GD_REMOVE_LOCAL_DATA_HINT)"
  Pop $0
  \${NSD_CreateCheckbox} 0 34u 100% 36u "$(GD_REMOVE_LOCAL_DATA_CHECKBOX) $odLocalDataRoot"
  Pop $odRemoveLocalDataCheckbox
  \${NSD_Check} $odRemoveLocalDataCheckbox
  nsDialogs::Show
FunctionEnd

Function un.GalyarderDesignLocalDataPageLeave
...
!macro customUnInstall
  ...
  \${If} $odRemoveLocalData != "0"
    DetailPrint "Removing local Galyarder Design data: $odLocalDataRoot"
