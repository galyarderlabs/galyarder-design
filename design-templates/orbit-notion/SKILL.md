...
od:
  ...
  design_system:
    requires: false
  example_prompt: >-
    Generate today's Open Orbit Notion briefing. Notion is my only connected connector — pull yesterday's document edits, comments, @ mentions, and database row changes and render the digest as a native Notion page.
---
...
8. **Callout block** — required. `gray bg`, 16px padding, rounded 6px,
   ...
   *"You still have 3 unreplied comments from yesterday — care to review them before Wednesday's all-hands?"*
...
11. **Closing callout** — second callout at the bottom acting as a CTA:
    `🚀 Continue in Galyarder Design →` linked back to the GD project.
...
| Use lorem ipsum | Write real-shaped Notion copy: doc titles like `Q3 OKR`, `Onboarding Document`, `Team Weekly Report`; people like Marie / Bob / Lily; comments like "Please confirm this section" |
