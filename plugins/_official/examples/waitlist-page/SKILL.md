...
7. **Emit clean HTML** — Single file, CSS inlined, SVG for graphics. Mark interactive elements with `data-gd-id` (headline, form, logo, ticker, grid, etc.) so agents can customize without parsing.
