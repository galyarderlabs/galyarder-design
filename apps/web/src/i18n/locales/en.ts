...
export const en: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Galyarder Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth':
    'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Galyarder Design.',
  ...
  'settings.mcpServerHint': 'Expose Galyarder Design as an MCP server for your coding agent.',
  ...
  'settings.mcpDaemonError':
    "Couldn't reach the local daemon to resolve install paths ({error}). Make sure Galyarder Design is running, then reopen this panel.",
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint':
    'apps/daemon/dist/cli.js is missing. Run `pnpm --filter @galyarder-design/daemon build` and refresh.',
  ...
  'settings.mcpCapabilityDefault':
    'Default to the project and file you have open in Galyarder Design, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote':
    'Galyarder Design must be running for MCP tool calls to succeed. If you started your coding agent before opening Galyarder Design, restart the agent so it can reach the live daemon.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Galyarder Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Galyarder Design — pick one and adopt.',
  ...
  'pet.slashSearch': 'Search the web through the GD research command.',
  ...
  'pet.codexBundledTitle': 'Ships with Galyarder Design — no download needed.',
  ...
  'updater.availableBody': 'Galyarder Design {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. Galyarder Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Galyarder Design',
  'updater.quitFailedBody': 'The installer is open, but Galyarder Design could not quit. Quit Galyarder Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Galyarder Design will close and open the installer.',
  'updater.readyVersion': 'Galyarder Design {version} is ready. Galyarder Design will close and open the installer.',
