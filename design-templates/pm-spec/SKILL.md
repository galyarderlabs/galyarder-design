...
description: |
  ...
  brief mentions "PRD", "spec", "product spec", "feature brief", or "Requirements Document".
triggers:
  - "prd"
  - "spec"
  - "product spec"
...
od:
  ...
  example_prompt: >-
    Write me a PRD for adding two-factor auth to our SaaS app — problem, scope, milestones, open questions.
---
