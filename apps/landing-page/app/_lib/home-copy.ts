 ...
 *
 * Locale-data file: this module hosts the landing-page i18n bundle and
 * functions identically to dictionary content under
 * `apps/web/src/i18n/locales/`. The non-English literals below are the
 * canonical translated copy for the landing page in each supported
 * locale; English (`en`) is the canonical source, every other locale is
 * a Partial override. Treat this as locale data for the purposes of the
 * repo's "100% English" policy — same role as the i18n locales folder.
 *
...
const en: HomeCopy = {
  ...
  aboutCaptionCredit: '(Galyarder Design, MMXXVI)',
  ...
  testimonialQuotePre: '“Galyarder Design helped us turn vague',
...
const ja: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '「Galyarder Design は私たちの曖昧な',
...
const ko: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '"Galyarder Design 은 우리의 모호한',
...
const de: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '„Galyarder Design hat uns geholfen, vage',
...
const fr: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '« Galyarder Design nous a aidés à transformer de vagues',
...
const esES: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '«Galyarder Design nos ayudó a convertir',
...
const ptBR: Partial<HomeCopy> = {
  ...
  testimonialLabel: 'Colaboradores · Nº 06',
  testimonialQuotePre: '"O Galyarder Design nos ajudou a transformar',
