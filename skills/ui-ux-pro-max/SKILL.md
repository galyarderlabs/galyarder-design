...
## Current Galyarder Design scope

Galyarder Design currently ships this entry as discovery metadata only. If this `SKILL.md`
...
If those upstream files are not installed, explain that Galyarder Design only has the
catalog entry for this skill and ask whether to continue with Galyarder Design's
