...
describe('ExamplesTab', () => {
  ...
  it('filters examples by free-text search and shows an empty match state', () => {
    ...
    expect(screen.queryByTestId('example-card-galyarder-design-landing')).toBeNull();
  ...
  it('narrows by surface, type, and scenario filter pills', () => {
    ...
    expect(screen.getByTestId('example-card-galyarder-design-landing')).toBeTruthy();
  ...
  it('passes the selected example to the Use this prompt callback', () => {
    ...
    fireEvent.click(screen.getByTestId('example-use-prompt-galyarder-design-landing'));
