...
export const ANALYTICS_HEADER_DEVICE_ID = 'x-gd-analytics-device-id';
export const ANALYTICS_HEADER_SESSION_ID = 'x-gd-analytics-session-id';
export const ANALYTICS_HEADER_CLIENT_TYPE = 'x-gd-analytics-client-type';
export const ANALYTICS_HEADER_LOCALE = 'x-gd-analytics-locale';
export const ANALYTICS_HEADER_REQUEST_ID = 'x-gd-analytics-request-id';
