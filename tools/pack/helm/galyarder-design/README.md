...
Deployment, Service, Secret, ConfigMap, two PVCs (`/data/gd` +
...
```bash
helm repo add galyarder-design https://galyarder-design.ai/charts
helm install gd galyarder-design/galyarder-design \
  --set image.tag=edge \
