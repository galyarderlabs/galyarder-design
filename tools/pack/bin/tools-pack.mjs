...
if (!existsSync(distEntry)) {
  throw new Error(
    `tools-pack dist entry not found at ${distEntry}. Run "pnpm --filter @galyarder-design/tools-pack build" first.`,
  );
}
...
if (isStale() && process.env.NODE_ENV !== "production") {
  console.warn(
    ...
    'Run "pnpm --filter @galyarder-design/tools-pack build" to rebuild.'
  );
}
