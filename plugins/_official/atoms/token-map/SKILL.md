---
name: token-map
description: Map an extracted Figma / source-code token bag onto the active GD design system, producing a deterministic mapping the generate stage can consume.
od:
...
target uses the active GD design system; we need a deterministic
