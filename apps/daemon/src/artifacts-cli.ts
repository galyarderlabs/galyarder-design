...
const USAGE = `Usage:
  gd artifacts create --name <path> --input <file> [--project <id-or-name>] [--manifest artifact.json] [--encoding utf8|base64] [--daemon-url <url>]

Creates one normal Galyarder Design project artifact entry file through the local daemon.
When --project is omitted, the active Galyarder Design project is used.
