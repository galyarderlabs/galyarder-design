...
Sister skill to [`galyarder-design-landing`](../galyarder-design-landing/).
...
The deck assumes 16 collage assets at `../galyarder-design-landing/assets/`
...
uses `'../galyarder-design-landing/assets/'`.

To regenerate or stub:

```bash
# Generate via gpt-image-2 (fal.ai)
FAL_KEY=fal-... npx tsx ../galyarder-design-landing/scripts/imagegen.ts \
  ../galyarder-design-landing/inputs.example.json \
  --out=../galyarder-design-landing/assets/
...
| Old | New |
| --- | --- |
| skill folder `editorial-collage-deck/` | `galyarder-design-landing-deck/` |
| shared assets `../editorial-collage/assets/` | `../galyarder-design-landing/assets/` |
| TS type `EditorialCollageDeckInputs` | `GalyarderDesignLandingDeckInputs` |
