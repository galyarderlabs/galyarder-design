# NotebookLM: export issues/PRs from Galyarder Design

Galyarder Design gets a lot of feedback via GitHub Issues + PRs. If you want NotebookLM to help with:
...
pnpm exec tsx scripts/notebooklm-export-github.ts \
  --repo galyarderlabs/galyarder-design \
  --out notebooklm/galyarder-design-snapshot.md
```
