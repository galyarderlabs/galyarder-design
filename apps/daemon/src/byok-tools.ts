...
// containing the literal Chinese error `参数错误：size`
// ("parameter error: size"; verified against logs from a failed call on
...
export interface BYOKToolContext {
  ...
  projectRoot: string;
  /** Daemon's PROJECTS_DIR (the `<projectRoot>/.gd/projects/` folder
...
export async function executeGenerateImage(
  ...
  // GD_SENSEAUDIO_API_KEY but forgot to fill the chat panel still
