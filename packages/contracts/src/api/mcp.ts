...
//
// Galyarder Design acts as an MCP CLIENT here: the user configures one or more
...
export interface McpServerConfig {
   ...
   * every run. */
  enabled: boolean;
  /** HTTP/SSE only: whether Galyarder Design should offer its managed OAuth flow.
 ...
 * its opener (and broadcasts on the `galyarder-design-mcp-oauth` channel). */
