---
title: "31 skills, 72 systems: how the Galyarder Design library works"
date: 2026-05-13
category: "Guides"
readingTime: 6
summary: "A walk through the four primitives that make Galyarder Design composable: skills, systems, adapters, and the daemon. With concrete examples of how a Markdown file becomes a pixel-perfect deliverable."
---

Galyarder Design is, mechanically, four primitives stacked on top of each other:
...
Every primitive — skills, systems, adapters — is a folder of text files. There is no central database. There is no "Galyarder Design account." There is no hosted service that has to keep working for your work to keep working.
