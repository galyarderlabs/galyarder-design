# Galyarder Design Manual Edit Mode Requirements

## Purpose

This document records the accepted manual edit-mode model from `apps/edit-mode-demo` so it can be migrated into the main Galyarder Design web app.
...
- Preserve Galyarder Design's existing preview model.
...
- Galyarder Design-specific mode rail:
  - Preview
  - Edit
  - Comment AI
  - Tweaks
...
Existing Galyarder Design integration points:
