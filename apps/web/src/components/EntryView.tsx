...
export function EntryView({
  ...
  return (
    <EntryShell
      ...
      onGalyarderDesignSystem={onGalyarderDesignSystem}
...
// skill hints in SKILL.md frontmatter (gd.fidelity, gd.speaker_notes,
// gd.animations) override the defaults so each example reproduces the
