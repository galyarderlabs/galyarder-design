...
name: kami-deck
description: >
  Produce a print-grade slide deck in the kami (kami, "paper") design system —
...
[`galyarder-design-landing-deck/scripts/compose.ts`](../galyarder-design-landing-deck/scripts/compose.ts).
Do **not** reuse the galyarder-design-landing-deck CSS; the visual
...
- **Do not** reuse Atelier Zero collage imagery (the galyarder-design-landing
...
- [`galyarder-design-landing-deck`](../galyarder-design-landing-deck/) — same
