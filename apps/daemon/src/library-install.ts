...
// Installed items live under ~/.galyarder-design/skills/ and
// ~/.galyarder-design/design-systems/ respectively.
 ...
 * @param {string} userDir - user-installed directory (e.g. ~/.galyarder-design/skills)
