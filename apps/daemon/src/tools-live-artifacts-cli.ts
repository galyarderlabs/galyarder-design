...
const LIVE_ARTIFACTS_USAGE = `Usage:
  gd tools live-artifacts create --input artifact.json
  gd tools live-artifacts list [--format compact]
  gd tools live-artifacts refresh --artifact-id <id>
  gd tools live-artifacts update --artifact-id <id> --input artifact.json
