...
For mixed-script runs (e.g. an English sentence with an italicized year
followed by CJK or RTL copy), split into
...
most common pairing in Galyarder Design today, but the same machinery
...
> (Devanagari conjuncts, four-mark Thai tone sequences, stacked
> Vietnamese composites). Adjust downward for condensed faces (Inter Condensed,
