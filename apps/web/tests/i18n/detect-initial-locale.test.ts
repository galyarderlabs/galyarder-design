...
const LS_KEY = 'galyarder-design:locale';
const LS_SOURCE_KEY = 'galyarder-design:locale-source';
...
// state into the next case (installMockGalyarderDesignHost returns an
...
function installHostWithOsLocale(value: unknown): void {
  uninstallHost?.();
  uninstallHost = installMockGalyarderDesignHost({
    host: {
